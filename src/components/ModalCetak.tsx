  ...
  return (
    ...
    <div className="fixed inset-0 z-[9999] bg-slate-100 dark:bg-slate-950 flex flex-col overflow-hidden animate-in fade-in duration-200 print-modal-root print:static print:z-auto print:bg-white print:overflow-visible print:h-auto">
      ...
      <div className="w-full h-full flex flex-col print:h-auto print:overflow-visible">
        ...
        <div className="print:hidden p-3 sm:px-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between gap-3 bg-white dark:bg-slate-900 flex-shrink-0 shadow-xs">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className={`p-2 ${systemLogoColor} text-white rounded-xl shadow-xs flex-shrink-0`}>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              onClick={handlePrint}
              className={`flex items-center justify-center gap-1.5 px-3.5 py-1.5 sm:px-4 sm:py-2 ${systemLogoColor} hover:brightness-110 text-white rounded-xl text-xs font-bold shadow-md transition-all cursor-pointer`}
            >
            ...
            <button
              onClick={onClose}
              className="p-1.5 sm:p-2 text-slate-400 hover:text-slate-700 justify-center flex dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors cursor-pointer"
        ...
        <div className="flex-1 overflow-y-auto overflow-x-auto p-2 sm:p-4 md:p-6 lg:p-8 print:p-0 print:bg-white print:overflow-visible flex justify-center items-start">
          <div className="print-canvas bg-white text-black p-4 sm:p-6 md:p-8 print:p-0 shadow-xl border border-slate-200 dark:border-slate-700 print:border-none print:shadow-none w-full max-w-[21cm] min-h-[29.7cm] font-sans leading-normal mx-auto box-border">
            
            {/* Kop / Header Dokumen Resmi */}
            <div className="border-b-2 border-slate-800 pb-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 break-inside-avoid">
              <div className="min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  {currentUser?.appLogo ? (
                    <img src={currentUser.appLogo} alt="Logo" className="w-8 h-8 object-contain rounded-lg flex-shrink-0" />
                  ) : (
                    <div className={`w-7 h-7 ${systemLogoColor} text-white rounded-lg flex items-center justify-center font-black text-sm flex-shrink-0`}>
                      {systemLogo}
                    </div>
                  )}
              ...
              <div className="text-left sm:text-right text-[11px] text-slate-600 font-mono flex-shrink-0">
            ...
            <div className="mb-6 text-center break-inside-avoid">
              ...
              {parentDomain && type === 'sub_domains' && (
                <p className="text-xs font-semibold text-slate-600 mt-0.5">
                  Domain Induk: <span className="font-mono text-blue-800 font-bold">{parentDomain.domain}</span> • IP Target: <span className="font-mono">{parentDomain.value}</span> • Tipe: <span className="font-mono">{parentDomain.type}</span>
                </p>
              )}
            </div>
            ...
            {group && type === 'allocations' && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs mb-6 p-3 bg-slate-50 border border-slate-200 rounded-xl break-inside-avoid">
                <div>
