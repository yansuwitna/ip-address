                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      {(() => {
                        ...
                        return (
                          <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/90 dark:border-slate-800 text-slate-700 dark:text-slate-300 text-xs font-semibold">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg transition-all cursor-pointer relative ${
                            itemServices.length > 0
                              ...
                              : 'hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-400 hover:text-blue-600'
                          }`}
                        >
