          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 flex-1">
            ...
            <div className="relative min-w-[200px] flex-1 sm:flex-none">
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs rounded-xl pl-9 pr-3 py-2 text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:bg-white dark:focus:bg-slate-900 dark:focus:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
              />
            </div>
