...
export const BatchReserveModal: React.FC<BatchReserveModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-900/60 backdrop-blur-xs overflow-hidden font-poppins animate-in fade-in duration-150">
      <div className="bg-white dark:bg-slate-900 border-x border-b border-t-0 border-slate-200 dark:border-slate-700 rounded-none sm:rounded-b-2xl sm:rounded-t-none w-full max-w-2xl mx-auto shadow-2xl overflow-hidden h-full flex flex-col animate-in zoom-in-95 duration-150">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* Actions */}
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:space-x-2 sm:gap-0 pt-3 border-t border-slate-100 w-full">
            <button
              type="button"
              onClick={onClose}
              className="justify-center px-4 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors cursor-pointer"
            >
              Batal
            </button>
            <button
              ...
              className="justify-center px-5 py-2 text-xs font-semibold bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white rounded-xl shadow-sm shadow-purple-600/30 transition-all cursor-pointer"
            >
              Simpan Rentang IP
            </button>
          </div>
