  ...
  return (
    <div className="space-y-6 font-poppins animate-in fade-in duration-200">
      ...
      <div className="min-h-full flex items-center justify-center p-0">
          <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 sm:p-7 max-w-xl w-full mx-auto shadow-2xl space-y-4 animate-in fade-in zoom-in-95 duration-150 max-h-[calc(100dvh-2rem)] sm:max-h-[calc(100dvh-3rem)] my-auto overflow-y-auto">
