  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl overflow-hidden shadow-xs flex flex-col font-poppins">
      ...
      <div className="p-4 border-b border-slate-200/80 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
        ...
        {/* Search & Filters */}
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center lg:justify-start gap-2 flex-1 w-full lg:w-auto">
          {/* Search Box */}
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center lg:justify-end gap-2 w-full lg:w-auto">
          {/* Next Free IP Button */}
          {nextFreeIp && (
            <button
              onClick={() => onAddAllocation(nextFreeIp)}
              className="flex items-center gap-1.5 justify-center px-3 py-1.5 bg-emerald-50 dark:bg-emerald-900/30 hover:bg-emerald-100 dark:hover:bg-emerald-800/50 border border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-300 rounded-xl text-xs font-semibold transition-all cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-1.5 justify-center px-3 py-1.5 bg-purple-50 dark:bg-purple-900/30 hover:bg-purple-100 dark:hover:bg-purple-800/50 border border-purple-200 dark:border-purple-800 text-purple-800 dark:text-purple-300 rounded-xl text-xs font-semibold transition-all cursor-pointer"
          >
          ...
          {onOpenPrint && (
            <button
              ...
              className="flex items-center gap-1.5 justify-center px-3 py-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-semibold transition-all cursor-pointer border border-slate-200 dark:border-slate-700"
            >
          ...
          <button
            ...
            className="flex items-center gap-1.5 justify-center px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-semibold shadow-xs shadow-blue-600/30 transition-all cursor-pointer"
          >
          ...
          <tbody className="divide-y divide-slate-100 text-slate-700 dark:text-slate-300">
            {filteredAllocations.length === 0 ? (
              ...
              filteredAllocations.map(item => {
                ...
                const itemServices = services.filter(s => (s.allocationId ? s.allocationId === item.id : (s.ip === item.ip && (!s.allocationId || s.allocationId === ''))));
